...
public class SpatialRegion {
    ...
    public SpatialRegion(float x1, float y1, float x2, float y2) {
        if (x1 >= x2 || y1 >= y2)
    ...
    public SpatialRegion getQuadrant(int quadrantIndex) {
        ...
        case 0:
            return new SpatialRegion(x1, y1, x1 + quadrantWidth, y1 + quadrantHeight);
        case 1:
            return new SpatialRegion(x1, y1 + quadrantHeight, x1 + quadrantWidth, y2);
        case 2:
            return new SpatialRegion(x1 + quadrantWidth, y1 + quadrantHeight, x2, y2);
        case 3:
            return new SpatialRegion(x1 + quadrantWidth, y1, x2, y1 + quadrantHeight);
        }
        return null;
    }

    public boolean containsPoint(SpatialPoint point) {
    ...
    public boolean doesOverlap(SpatialRegion testRegion) {
